                        ...
                        <div class="row justify-content-center py-sm-3 py-md-5">
                            ...
                            <div class="col-sm-10 col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-alt"  v-model="supplierData.name" placeholder="Enter the supplier name..">
                                </div>
                                <div class="form-group">
                                    <label class="">Phone Number</label>
                                    <input type="text" class="form-control form-control-alt"  v-model="supplierData.phone_number" placeholder="Provide phone number">
                                </div>
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        saveSupplier: function(event) {
            ...
            axios.patch('/suppliers/'+this.supplier.id, this.supplierData)
            .then(($response) => {
