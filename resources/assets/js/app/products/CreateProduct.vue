                        ...
                        <div class="row justify-content-center py-sm-3 py-md-5">
                            <div class="col-sm-10 col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-alt"  v-model="product_name" placeholder="Enter the supplier name..">
                                </div>
                                <div class="form-group">
                                    <label class="">Product Code</label>
                                    <input type="text" class="form-control form-control-alt"  v-model="product_code" placeholder="Enter a unique product code">
                                </div>
                                <div class="form-group">
